      ...
      <div>
        ...
        <div class="flex gap-2">
          <button
            ...
            class="btn-primary flex-1 px-3 py-2 active:scale-95 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2"
          >
    ...
    <div class="space-y-3">
      <div class="flex gap-2">
        <button
          ...
          class="btn-primary flex-1 px-3 py-2 active:scale-95 rounded-lg text-sm font-medium transition-all duration-200"
        >
          Add Media to Queue
        </button>
        <button
